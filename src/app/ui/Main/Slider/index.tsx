...
import eventBanner from '../../../../../public/images/eventobanner.jpg'
...
const Slide = () => {
    ...
    return (
        <Slider className="slide" {...settings}>
            ...
            <div className="h-full">
                <div className="h-full">
                    ...
                    <div className="absolute md:top-36 top-24 left-10">
                        <div>
                            <h4 className="bg-customText text-[#fff] rounded rounded-bl-none rounded-tl-none text-2xl md:text-3xl p-2 w-fit">Estamos JOBdidos Vol. 2</h4>
                            <div>
            ...
            <div className="h-full">
                <div className="h-full">
                    <Image src={eventBanner} alt="banner" className="w-full h-full object-cover" />
                    <div className="absolute md:top-36 top-24 left-10">
                        <div>
                            <h4 className="bg-customText text-[#fff] rounded rounded-bl-none rounded-tl-none text-2xl md:text-3xl p-2 w-fit">Viva el Perú</h4>
                            <div>
                                <div className="flex items-center w-fit bg-customText text-[#fff] rounded rounded-bl-none rounded-tl-none text-md p-2 ">
                                    <p className="ml-2">SAB <strong className="font-normal block">14 DIC</strong></p>
                                    {/* {moment(item.FechaInicio).format('ddd').toUpperCase()} */}
                                    <div className="border-l border-solid border-[#fff] ml-4">
                                       <p className="ml-3"> 21:00 - 22:00 Joinnus Live</p>
                                        {/* {moment(item.FechaInicio).format('DD MMM').toUpperCase()} */}
                                    </div>
                                </div>
                                <div>
